...
{
	int                                                HighIntData[ 0x4 ];                               		// 0x0000 (0x0010) [0x0000000000000000]              
};
...
{
	struct FPlane                                      DummyPlane;                                       		// 0x0000 (0x0010) [0x0000000000000000]              
	float                                              Padding[ 0x44 ];                                  		// 0x0010 (0x0110) [0x0000000000000000]              
};
