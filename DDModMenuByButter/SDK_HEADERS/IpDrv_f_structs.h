...
struct UMeshBeaconClient_execSendHostNewGameSessionResponse_Parms
{
	...
	unsigned char                                      PlatformSpecificInfo[ 0x44 ];                     		// 0x0010 (0x0044) [0x0000000000000182]              ( CPF_Const | CPF_Parm | CPF_OutParm )
...
struct UMeshBeaconClient_execOnTravelRequestReceived_Parms
{
	struct FName                                       SessionName;                                      		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	class UClass*                                      SearchClass;                                      		// 0x0008 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned char                                      PlatformSpecificInfo[ 0x44 ];                     		// 0x000C (0x0044) [0x0000000000000182]              ( CPF_Const | CPF_Parm | CPF_OutParm )
};
...
// [0x00020000] 
struct UOnlineGameInterfaceImpl_execCancelPendingAsyncTasks_Parms
{
};
...
struct UOnlineGameInterfaceImpl_execReadPlatformSpecificSessionInfo_Parms
{
	...
	unsigned char                                      PlatformSpecificInfo[ 0x44 ];                     		// 0x000C (0x0044) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
...
struct UOnlineGameInterfaceImpl_execJoinOnlineGame_Parms
{
	...
	TArray< int >                                      participatingPlayerControllerIds;                 		// 0x0018 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
...
struct UOnlineGameInterfaceImpl_execFindOnlineGames_Parms
{
	unsigned char                                      SearchingPlayerNum;                               		// 0x0000 (0x0001) [0x0000000000000080]              ( CPF_Parm )
	class UOnlineGameSearch*                           SearchSettings;                                   		// 0x0004 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	int                                                numParticipatingLocalPlayers;                     		// 0x0008 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	struct FName                                       SessionName;                                      		// 0x0000 (0x0008) [0x0000000000000080]              ( CPF_Parm )
	unsigned long                                      bShouldCleanupTasks : 1;                          		// 0x0008 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
// [0x00020000] 
struct UOnlineGameInterfaceImpl_execCreateOnlineGameFailureID_Parms
{
	int                                                ReturnValue;                                      		// 0x0000 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
struct UOnlineGameInterfaceImpl_execCreateOnlineGame_Parms
{
	...
	TArray< int >                                      participatingPlayerControllerIds;                 		// 0x0010 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
