...
struct AGameCrowdAgent_execInitializeAgent_Parms
{
	...
	// struct FVector                                  TryLoc;                                           		// 0x0028 (0x000C) [0x0000000000000000]              
	...
	// struct FVector                                  ViewLocation;                                     		// 0x0050 (0x000C) [0x0000000000000000]              
	// struct FVector                                  YAdjust;                                          		// 0x005C (0x000C) [0x0000000000000000]              
	// struct FRotator                                 ViewRotation;                                     		// 0x0068 (0x000C) [0x0000000000000000]              
	// class APlayerController*                        PC;                                               		// 0x0074 (0x0004) [0x0000000000000000]              
	// unsigned long                                   bVisibleTryLoc : 1;                               		// 0x0078 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
// [0x00020802] ( FUNC_Event )
struct AGameCrowdDestination_eventGetSpreadValue_Parms
{
...
// [0x00820002] 
struct AGameCrowdPopulationManager_execInitializeSpawnPoints_Parms
{
	struct FVector                                     ViewLocation;                                     		// 0x0000 (0x000C) [0x0000000000000080]              ( CPF_Parm )
	struct FVector                                     PredictionLocation;                               		// 0x000C (0x000C) [0x0000000000000080]              ( CPF_Parm )
	// class AGameCrowdDestination*                    GCD;                                              		// 0x0018 (0x0004) [0x0000000000000000]              
	...
	// int                                             J;                                                		// 0x003C (0x0004) [0x0000000000000000]              
	// unsigned long                                   bInsertedSpawnPoint : 1;                          		// 0x0040 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct AGameCrowdPopulationManager_execDisplayDebug_Parms
{
	...
	// struct FVector                                  HitLocation;                                      		// 0x0034 (0x000C) [0x0000000000000000]              
	// struct FVector                                  ViewLocation;                                     		// 0x0040 (0x000C) [0x0000000000000000]              
	// struct FRotator                                 ViewRotation;                                     		// 0x004C (0x000C) [0x0000000000000000]              
	// class APlayerController*                        PC;                                               		// 0x0058 (0x0004) [0x0000000000000000]              
	// class AGameCrowdAgent*                          GCD;                                              		// 0x005C (0x0004) [0x0000000000000000]              
};
...
struct AGameExplosionActor_execHurtExplosion_Parms
{
	...
	// TArray< class AActor* >                         VictimsList;                                      		// 0x0068 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct AMobileHUD_execDrawInputOverlays_Parms
{
	...
	// float                                           ClampedX;                                         		// 0x0068 (0x0004) [0x0000000000000000]              
	// float                                           ClampedY;                                         		// 0x006C (0x0004) [0x0000000000000000]              
	// float                                           Scale;                                            		// 0x0070 (0x0004) [0x0000000000000000]              
	// class UTexture2D*                               BackgroundTexture;                                		// 0x0074 (0x0004) [0x0000000000000000]              
	// struct FColor                                   LineColor;                                        		// 0x0078 (0x0004) [0x0000000000000000]              
};
...
{
	struct FPostProcessSettings                        PP;                                               		// 0x0000 (0x00A0) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
};
